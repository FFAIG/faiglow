...
export const siteConfig = {
  ...
  footer: {
    columns: [
      ...
      { heading: "BİZE ULAŞIN", text: "E-mail", phone: "+90 555 158 83 07" },
      {
        heading: "FAI",
        links: [
...
export const homeContent = {
  ...
  hero: {
    ...
    mobileBackgroundImage: { src: "/TURUNCUİÇMEKAN(9.16).png" },
